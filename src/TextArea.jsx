...
const TextArea = ({ name, type, placeholder, values, handleBlur, handleChange, errors, touched, }) => {
    ...
    return (
        <div className=" flex flex-col gap-1 text-start">
            <div className={` ${errors && touched ? " border-red-500" : ""} w-full flex items-start justify-between border-2 border-gray-600 p-2 rounded-md gap-2`}>
